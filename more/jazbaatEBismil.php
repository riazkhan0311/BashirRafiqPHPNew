        ...
        <div class="box">
            <div class="col-lg-12">
                ...
                <h2 class="intro-text text-center">
                    <strong>Jazbaat e Bismil</strong>
                </h2>
                <hr>
                ...
                <div class="chapterContent">
                    ...
                    <img class="img-responsive img-border img-center" src="../img/moreImg/jazbaat-e-bismil.jpg" alt="">


                </div>
                <div class="col-lg-12 text-center">
                    <ul class="pager">
                        <li class="middle"><a href="../more.html">More</a>
                        </li>
