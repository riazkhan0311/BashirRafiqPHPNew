        ...
        <div class="box">
            <div class="col-lg-12">
                ...
                <h2 class="intro-text text-center">
                    <strong>Chapter 11: Giving Up Smoking</strong>
                </h2>
                <hr>
                ...
                <div class="chapterContent">
                    ...
                    <div class="quote">"Those who decide to give up smoking often think that they can be rid of the habit even if they begin to abstain after having finished the packet in their pocket or by gradually reducing the number of cigarettes they smoke per day. However, these methods always remain ineffective. It is my advice that when you go downstairs, you should crush under your feet the packet of your cigarettes that you may have hidden somewhere. You should go downstairs with full determination that you will never touch a cigarette again.
                        ...
                        The fourth part of my advice is that, as generally the urge to smoke crops up after a meal or after eating something, you should keep some roasted gram in your pocket. When you feel the craving for a smoke, eat some gram and this way the want of a cigarette will be substantially reduced."</div>

                    <p>At the end, Huzoor said:</p>
                    <br />

                    <div class="quote">"You must follow these instructions for 40 days. After 40 days, report to me and truthfully tell me what came to pass."</div>

                    <p>Before I left, I promised to act 100 % in accordance with Huzoor's instructions.</p>
                    <br />
                    <p>For the first few days I was miserable; I was restless and fidgety all the time. I could not devote my full attention to any matter. However, I remained 100 % firm in my determination to keep my promise. After 10 or 12 twelve days, slowly, the desire of a cigarette began to subside. After 40 days I had totally forgotten that I ever smoked. On the 41st first day I went to see Huzoor. As soon as I entered, Huzoor asked:</p>
                    <br />

                    <div class="quote">"Was my prescription a success?"</div>

                    <p>I answered by saying:</p>
                    <br />

                    <div class="quote">"Huzoor, 100 %."</div>

                    <p>Huzoor said aloud:</p>
                    <br />

                    <div class="quote">"Alhamdolillah."</div>

                    <p>He asked how, having given up smoking, I felt. I said that I had put on some weight and I could not understand why. Huzoor said:</p>
                    <br />

                    <div class="quote">"As tobacco diminishes the sense of taste food intake diminishes. Now that you do not smoke, your sense of taste has improved. Your improved food intake has been responsible for the additional weight. This is only natural."</div>


                </div>
                <div class="col-lg-12 text-center">
                    <ul class="pager">
                        <li class="previous"><a href="10marriageAndChildren.php">&larr; Chapter 10</a>
                        </li>
                        <li class="middle"><a href="11givingUpSmoking.php">Back to Top</a>
                        </li>
                        <li class="next"><a href="12memorableJourneyToEngland.php">Chapter 12 &rarr;</a>
                        </li>
                    </ul>
                </div>
            </div>
