        ...
        <div class="box">
            <div class="col-lg-12">
                ...
                <h2 class="intro-text text-center">
                    <strong>Chapter 52: An Address</strong>
                </h2>
                <hr>
                ...
                <div class="chapterContent">
                    ...
                    <div class="quote">"The Imam Mr B.A. Rafiq has left for Pakistan under the instructions of Hadhrat Khalifa tul Masih. His twelve years of stay in this country have endeared him to people who had the opportunity to meet him. As both the Missionary in Charge as well as an individual his work stands out in the history of the London Mission."
                        ...
                        "(The Muslim Herald January 1971).</div>


                </div>
                <div class="col-lg-12 text-center">
                    <ul class="pager">
                        <li class="previous"><a href="51pakistanRiots1974.php">&larr; Chapter 51</a>
                        </li>
                        <li class="middle"><a href="52anAddress.php">Back to Top</a>
                        </li>
                        <li class="next"><a href="53educationAndTarbiyyatActivities.php">Chapter 53 &rarr;</a>
                        </li>
                    </ul>
                </div>
            </div>
